...
export default function Alert(props: AlertProps) {
  ...
  const styles: Record<string, { container: string, closeIcon: string }> = {
    error: {
      container: 'text-red-800 border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800',
    ...
    success: {
      container: 'text-green-800 border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400',
  ...
  return (
    <div className={`flex items-center text-center p-4 mb-4 text-sm border ${selectedStyle.container}`} role='alert'>
